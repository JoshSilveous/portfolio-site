...
export function FrontEndContent() {
	...
	const sections = [
		...
		},
		{
			...
			paragraph: (
				<>
					I have been working with React for years, using it almost exclusively to develop
					my web applications. Developing applications with React isn't always the best
					choice, but it is much better than vanilla HTML & JS for most interactive web
					applications. React's component-based development architecture has allowed me to
					develop complex applications, such as my{' '}
					<a href='#projects/guitar-visualizer'>Guitar Visualizer</a>, with much less
					boilerplate.
				</>
			),
		},
		{
			...
			paragraph: (
				<>
					...
					<a href='https://scrimba.com/'>Scrimba.com</a>) learning how React Router works,
					and have implemented it on a few small projects for learning purposes. Also, I
					am currently implementing it into my{' '}
