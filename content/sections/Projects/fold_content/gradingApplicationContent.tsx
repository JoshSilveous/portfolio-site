...
export const gradingApplicationContent = (
	<div className='fold guitar-visualizer'>
		...
		<div className='description'>
			...
			<p>
				Using SQLite, the user can keep track of multiple classes. Students can be
				enrolled in multiple classes, and classes can contain multiple students. Each
				class can have multiple assignments, categorized by <strong>Homework</strong>{' '}
				and <strong>Tests</strong>. Those assignments can be{' '}
				<strong>Extra Credit</strong>, meaning that they don&apos;t negatively impact
				the final grade. Individual users can be made <strong>Exempt</strong> from
				grades on specific assignments, for cases such as missing class on the day of
				a test.
			</p>
			<h3>Interface</h3>
			<p>
				The UI is built using React and SCSS, with the main interface being a table,
				and a custom popup system used for detailed database insertions, such as
			...
			<h3>Electron</h3>
			<p>
				This program was built with <strong>Electron</strong>, which allows me to
				build fully featured OS applications using Node.js for OS functions, such as
				writing data, and React for building the UI. No internet connection needed.
			</p>
			<p>
