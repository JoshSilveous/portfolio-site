...
export const backendContent: SkillSectionInfo[] = [
	{
		...
		additional_content: (
			<>
				...
				<TextWithIcon
					Icon={ProjectsIcon}
					href='#projects/grading-application'
					inline
				>
					Grading Application
				</TextWithIcon>{' '}
	...
	},
	{
		...
		additional_content: (
			<>
				...
				that using Postman to manually test my code was taking up a lot of time. When
				looking into alternatives, I discovered Jest, and spent some time writing up
				tests to ensure that every function of my API behaves appropriately.
			</>
		),
	},
	{
		...
		additional_content: (
			<>
				...
				and requires very little code to do so. You simply create a schema, then
				create middleware functions for your API routes that validate objects against
				it (and methods to handle different validation outcomes).
			</>
		),
	},
	{
		...
		additional_content: (
			<>
				Electron itself has a fairly minimal learning curve if you already know how
				to develop front-end and back-end applications. I used Electron to create my{' '}
				<TextWithIcon
					Icon={ProjectsIcon}
					href='#projects/grading-application'
					inline
